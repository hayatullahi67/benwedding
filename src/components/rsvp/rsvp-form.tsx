    ...
    try {
        ...
        if (data.attending === "yes" && data.name && data.email) {
            ...
            const emailBody = `
              ...
              <br>
              Venue: Agaya Hotel, Kwandere Road. Lafia
              <br>
              Date: 1st Nov, 2025
              <br>
              Time: 4pm
              ...
              <ul>
                <li>Please arrive 15–20 minutes early so you don’t miss the grand entrance.</li>
                <li>Colors Of the Day: Metallic Brown, Burgundy and Tan</li>
                <li>For questions, kindly reach us at: 08169536118</li>
              </ul>
              <br>
              We can’t wait to share the joy, laughter, food, music, and dance with you! 🎶💃🕺
              <br><br>
              With love,
              <br>
              DeeWealth💍
