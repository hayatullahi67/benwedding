...
const mockMemories = [
    { id: 1, name: "Aunt Carol", message: "So excited for you both! Wishing you a lifetime of happiness.", liked: false, date: "2 days ago" },
    { id: 2, name: "John & Sarah", message: "Can't wait to celebrate with you! The invitation is beautiful.", liked: true, date: "3 days ago" },
    { id: 3, name: "Michael P.", message: "Congratulations! So happy to be a part of your special day.", liked: false, date: "5 days ago" },
    { id: 4, name: "The Millers", message: "Wishing you all the best on your journey together. Cheers!", liked: true, date: "1 week ago" },
    { id: 5, name: "Cousin Dave", message: "Get ready to party! So thrilled for you two.", liked: false, date: "1 week ago" },
    { id: 6, name: "Grandma Sue", message: "My darlings, I am overjoyed. Can't wait to see you walk down the aisle.", liked: true, date: "2 weeks ago" },
];
    ...
    <div className="container mx-auto px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-foreground/80">Leave a note for the happy couple!</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {memories.map((memory) => (
                <Card key={memory.id} className="rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col">
